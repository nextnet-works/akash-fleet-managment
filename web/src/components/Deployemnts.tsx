    ...
    return (
        <div>
            ...
            {data?.deployments.map((deployment) => (
                <div key={deployment.escrow_account.id.xid} style={{border: "1px solid black", display: "flex", gap: "15px", padding: "10px", alignItems: "center", width: "fit-content", borderRadius: "10px"}}>
